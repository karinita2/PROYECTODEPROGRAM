...
<div class="modal-content">
    <h3 align="center"><b>Registrar Encargado o Empresa</b></h3>
    <div class="col s12 m12 l6">
        <div class="card">
            <div class="card-content">
                <span ><b>Datos Encargado o Empresa</b></span>
                <form class="col s12" method="post" id="createUser" action="{{ url('/reservation/store') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s12">
                            ...
                            <label for="icon_prefix" class="">Carnet/Nit</label>
                        </div>
                        <div class="input-field col s6">
                            <input placeholder="Nombres" id="name" name="name" type="text" class="validate">
                            <label for="first_name" class="active">Nombre del Encargado</label>
                        </div>
                        <div class="input-field col s6">
                            <input placeholder="Apellido" id="last_name" name="last_name" type="text" class="validate">
                            <label for="first_name" class="active">Apellido del Encargado</label>
                        </div>
                    </div>
                    <div class="row">
