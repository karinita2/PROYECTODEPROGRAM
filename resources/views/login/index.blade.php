...
<section class="section-account">
    <div class="img-backdrop" style="background-image: url('../../assets/img/images/img16.jpg')"></div>
        ...
        <div class="card-body">
            <div class="row">
                    ...
                    <form class="form floating-label" action="../../html/dashboards/dashboard.html" accept-charset="utf-8" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6 text-right">
                                <button class="btn btn-primary btn-raised" type="submit">Aceptar</button>
                            </div><!--end .col -->
                        </div><!--end .row -->
                    </form>
                </div><!--end .col -->
                <div class="col-sm-5 col-sm-offset-1 text-center">
                    ...
                    <a class="btn btn-block btn-raised btn-primary" href="#">Registrate aquí</a>
